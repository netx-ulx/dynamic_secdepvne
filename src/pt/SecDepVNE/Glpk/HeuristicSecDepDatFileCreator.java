...
public class HeuristicSecDepDatFileCreator{
	 ...
	 * @param mappedNodes 
	 */
	public void createDatFile(String file, SubstrateNetwork subNet, VirtualNetwork virNet, ArrayList<Pair<String>> mappedNodes, LinkHeuristicInfo linkHeuristicInfo) {
	 ...
	 * @throws IOException
	 */
	public void putNetInfo(BufferedWriter bufferedWriter, SubstrateNetwork subNet, VirtualNetwork virNet, ArrayList<Pair<String>> mappedNodes, LinkHeuristicInfo virtualLinkHeuristicInfo) throws IOException {
		...
		for(int i = 0; i < sNodes; i ++){
			...
			for(int j = 0; j < sNodes; j++){
				...
				if(indexEdgeIJ != -1 &&
						(subNet.getEdgeSec(indexEdgeIJ)) >= virNet.getEdgeSec(virtualLinkHeuristicInfo.getIndexLink())){
					...
					if( indexEdgeJI != -1 &&
							(subNet.getEdgeSec(subNet.getEdges().indexOf(new Pair<String>(subNet.getNode(j),subNet.getNode(i)))) >= virNet.getEdgeSec(virtualLinkHeuristicInfo.getIndexLink()))){
	 ...
	 * @throws IOException
	 */
	public void putVirNetInfo(BufferedWriter bufferedWriter, VirtualNetwork virNet) throws IOException {
