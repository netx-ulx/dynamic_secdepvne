...
public class SecDepDatFileCreator{
	 ...
	 */
	public void createDatFile(String file, SubstrateNetwork subNet, VirtualNetwork virNet) {
	 ...
	 * @throws IOException
	 */
	public void putSubNetInfo(BufferedWriter bufferedWriter, SubstrateNetwork subNet) throws IOException {
